                    ...
                    for reg2 in [0,0.005,0.01]:
                        for layer_size in [16,24,32]:
                            ...
                            for seed in range(10): #number of runs per hyperparameter set
                                ...
                                model.add(keras.layers.Dense(units=layer_size, activation="relu", kernel_regularizer=keras.regularizers.l1_l2(reg1,reg2), bias_regularizer=keras.regularizers.l1_l2(reg1,reg2))
                                model.add(keras.layers.Dense(units=layer_size, activation="relu", kernel_regularizer=keras.regularizers.l1_l2(reg1,reg2), bias_regularizer=keras.regularizers.l1_l2(reg1,reg2))
